...
class NavigatorFunctions {
    constructor() {
        ...
        this.REGISTER_NAME_ENTRY = document.getElementById("registerName");
        this.AEON_PRACTICE_HOME_BTN = document.getElementById("aeon-practice-home-btn");
        this.AEON_MANAGE_BTN = document.getElementById("aeon-manage-btn");
        this.DAISO_PRACTICE_HOME_BTN = document.getElementById("daiso-practice-home-btn");
        this.DAISO_MANAGE_BTN = document.getElementById("daiso-manage-btn");
        this.BTN_PACKED = this.initBtnPack();
        this.setEvents();
    }
    initBtnPack() {
        return [
            { pageName: "eaonCheckout", element: this.AEON_PRACTICE_HOME_BTN },
            { pageName: "aeonControlePanel", element: this.AEON_MANAGE_BTN },
            { pageName: "daisoCheckout", element: this.DAISO_PRACTICE_HOME_BTN },
            { pageName: "daisoControlePanel", element: this.DAISO_MANAGE_BTN }
        ];
    }
    setEvents() {
        for (const { pageName, element } of this.BTN_PACKED) {
            element.addEventListener("click", () => {
                this.navigateNewPage(pageName);
            });
        }
    }
    navigateNewPage(pageName) {
        this.URL_FUNCTIONS.redirect({ METHOD: "toSelectedPage", PAGE_TITLE: pageName, CALL_FROM: "MainApp", QUERY: this.getRegisterName() });
    }
    getRegisterName() {
        return this.REGISTER_NAME_ENTRY.value;
    }
}
const APP = new NavigatorFunctions();
//# sourceMappingURL=selfCheckOutHome.js.map